...
(function ($) {
    ...
    if (navexpander.length) {
        $('#nav-expander, #nav-expander2, #nav-close, #nav-close2, .offwrap, #about').on('click', function (e) {
            e.preventDefault();
        ...
        $('#dikta,#jon,#pulung,#ukm,#danisa,#teater,#dfu,#psm,#tari,#gamelan').on('click', function (e) {
            e.preventDefault();
            $('body').removeClass('nav-expanded');
            $('html, body').animate({
                scrollTop: $("#rs-team").offset().top
            }, 100);
        });
        $('#dikta2').on('click', function (e) {
            e.preventDefault();
            $('body').removeClass('nav-expanded');
            $('html, body').animate({
                scrollTop: $("index.php#rs-team").offset().top
            }, 100);
        });
        $('#jadwal').on('click', function (e) {
            ...
            $('body').removeClass('nav-expanded');
            $('html, body').animate({
                scrollTop: $("#rs-events-schedule").offset().top
            }, 100);
        });
        $('#pendaftaran').on('click', function (e) {
            ...
            $('body').removeClass('nav-expanded');
            $('html, body').animate({
                scrollTop: $("#rs-pendaftaran").offset().top
            }, 100);
        });
        $('#pendaftaran2').on('click', function (e) {
            e.preventDefault();
            $('body').removeClass('nav-expanded');
            $('html, body').animate({
                scrollTop: $("#rs-pendaftaran2").offset().top
            }, 100);
        });
        $('#beranda').on('click', function (e) {
            ...
            $('body').removeClass('nav-expanded');
            $('html, body').animate({
                    scrollTop: $("index.php").offset().top
                },
                100);
        });
        $('#sponsor').on('click', function (e) {
            ...
            $('body').removeClass('nav-expanded');
            $('html, body').animate({
                scrollTop: $("#rs-our-sponsor").offset().top
            }, 100);
        });
